...
const APP_REGISTRY = {
  ...
  infinite_knowledge: {
    ...
    description: 'RAG / knowledge retrieval with MCP server — app runs on Kaydanski, tunnel on Toshi',
    url: 'https://ik.birdmug.com',
    category: 'app',
    containers: ['infinite_knowledge_cloudflared'],
    primary: 'infinite_knowledge_cloudflared',
  },
  caravaggio: {
    name: 'Caravaggio',
    description: 'Image processing service — app runs on Kaydanski, tunnel on Toshi',
    url: 'https://art.birdmug.com',
    category: 'app',
    containers: ['caravaggio_cloudflared'],
    primary: 'caravaggio_cloudflared',
  },
  uptime_kuma: {
    name: 'Uptime Kuma',
  ...
  ai_pulse: {
    name: 'AI Pulse',
    description: 'Live view of the AI fleet — loaded models with VRAM, gateway + Kyle-Rag health',
    url: 'https://ai-pulse.birdmug.com',
    category: 'infra',
    containers: ['ai_pulse', 'ai_pulse_cloudflared'],
    primary: 'ai_pulse',
  },
  ollama_gateway: {
    name: 'Ollama Gateway',
    description: 'LiteLLM proxy in front of Kaydanski Ollama — queueing, rate limits, virtual keys, OpenAI-compatible. Tailnet only at 192.168.4.31:4000.',
    url: null,
    category: 'infra',
    containers: ['ollama_gateway'],
    primary: 'ollama_gateway',
  },
  mattermost: {
    name: 'Mattermost',
